from repository import SessionRepo, CANFrameRepo, SignalRepo, VehicleStateRepo
...
def create_vehicle_state(state: dict):
    return VehicleStateRepo.create_vehicle_state(state=state)
