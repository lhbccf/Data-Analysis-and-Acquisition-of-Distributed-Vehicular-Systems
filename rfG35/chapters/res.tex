...
This chapter presents the validation of the platform across three test
environments — Bench, Vehicle, and Formula Student — followed by a dedicated
...
\begin{itemize}
    \item uaEFI	\cite{rusefi_website}
    \item Raspberry Pi Zero 2W (with headers) \cite{raspizero2w}
    \item Motorola G35 5G \cite{motog35}
\end{itemize}
...
integrated pipeline.
No bench validation was performed with a RusEFI ECU due to testing contraints.
...
A 5-minute driving session produced approximately 1000 CAN frames stored
...
non-interactable. All 13 sensor fields updated correctly at 10~Hz in the live
